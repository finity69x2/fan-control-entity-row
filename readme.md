...
## This plugin is only valid for use with Home Assistant Version 2021.2.x and before. fo HA versions after that use fan-percent-button-row or fam-mode-button-row.
